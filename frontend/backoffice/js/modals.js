...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // NOTE: These actions are handled exclusively by pedidos.js and must NOT
        // be processed here (they use different data attributes like data-telefono,
        // not data-id, so invoking them here would pass undefined as the argument).
        const PEDIDOS_OWNED_ACTIONS = new Set([
            'view', 'edit', 'delete', 'verClientePerfil', 'resolver'
        ]);
        ...
        document.addEventListener('click', (e) => {
            ...
            // Skip actions that belong to the pedidos table handler
            if (PEDIDOS_OWNED_ACTIONS.has(action)) return;
